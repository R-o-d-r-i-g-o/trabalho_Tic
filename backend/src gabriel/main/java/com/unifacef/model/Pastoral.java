...
public class Pastoral {
	...
	public Pastoral(String nome, Long criador_id, String descricao, boolean grupos, int intervalo) {
		super();
		this.nome = nome;
	...
	public Pastoral(Long id, String nome, Long criador_id, String descricao, boolean grupos, int intervalo) {
		super();
		this.id = id;
		this.nome = nome;
		this.criador_id = criador_id;
